...
BEGIN
	...
	begin try
	   ...
	   -- declare @Sheet1 varchar(64) = 'Sheet1' 
		...
		declare @NotifyEmail varchar(1024) = 'backoffice@armbrok.am;QORT@armbrok.am;'--;sona.nalbandyan@armbrok.am;armine.khachatryan@armbrok.am;''aleksandr.mironov@armbrok.am'
