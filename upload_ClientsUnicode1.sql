...
CREATE PROCEDURE [dbo].[upload_ClientsUnicode1]
...
BEGIN
	...
	begin try
		...
		insert into QORT_BACK_TDB.dbo.Firms (ET_Const, IsProcessed, BOCode, NameU, AddrFSettlementU, OrgCathegoriy_NAME)
		...
		where (t.NameU <> '' and t.NameU <> isnull(fp.NameU, '')) or (t.AddrFSettlementU <> '' and t.AddrFSettlementU <> isnull(fp.AddrFSettlementU, '') or t.OrgCathegoriyID <> '')
